...
button.addEventListener("click", () => {
  ...
  if (heightStatus && weightStatus) {
    ...
    if (bmi < 18.5) {
      result.innerHTML = "BMI: " + bmi + "Weight Status: Underweight";
    } else if (bmi >= 18.5 && bmi <= 24.9) {
      result.innerHTML = "BMI: " + bmi + "Weight Status: Normal";
    } else if (bmi >= 25 && bmi <= 29.9) {
      result.innerHTML = "BMI: " + bmi + "Weight Status: Overweight";
    } else if (bmi >= 30 && bmi <= 34.9) {
      result.innerHTML = "BMI: " + bmi + "Weight Status: Obese";
    } else {
      result.innerHTML = "BMI: " + bmi + "Weight Status: Extremely obese";
    }
  } else {
